...
$(document).ready(function(){
	...
	if(y!=null){
		...
		$(".bdlogo").attr("src","img/bd_logo1_31bdc765.png");		
	}
...
$(document).ready(function(){
	...
	$(".s-skin-set").click(function(){
		localStorage.clear();
		localStorage.setItem('src','img/bd_logo1_31bdc765.png');
		...
		$(".bdlogo").attr("src","img/bd_logo1_31bdc765.png");//将百度logo还原
...
$(document).ready(function(){
	$(".skin-img-item").each(function(index){
		...
		$(this).hover(function(){//鼠标划入当前li
			...
			$(".preview-skin-view").attr("src",'img/bg'+i+'.jpg');
			$(this).click(function(isClick){//是否点击选取，是则isClick返回true
				...
				// 使预览图片和背景图片一致
				$(".preview-skin-view").attr("src",'img/bg'+i+'.jpg');//需存！！？？
				// 改变百度logo为白色
